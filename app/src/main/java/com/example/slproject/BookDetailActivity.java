...
public class BookDetailActivity extends AppCompatActivity {
    ...
    private void submitBookRegistration() {
        ...
        // Save to History
        saveToHistory(receiptNo, bookTitle, borrower, studentEmail, takeDate, retDate, bookAuthor);
    ...
    private void saveToHistory(int id, String title, String name, String email, String tDate, String rDate, String author) {
        ...
        // Using a fresh HashSet to ensure modification works
        Set<String> newHistorySet = new HashSet<>(historySet);
        
        // Format: ID|Title|Name|Email|TakeDate|ReturnDate|Author
        String entry = id + "|" + title + "|" + name + "|" + email + "|" + tDate + "|" + rDate + "|" + author;
        newHistorySet.add(entry);
        
        historyPrefs.edit().putStringSet("history_list", newHistorySet).apply();
    }
    ...
    private void scheduleEmailReminder(String returnDateStr) {
        try {
            ...
            OneTimeWorkRequest reminderWork = new OneTimeWorkRequest.Builder(EmailReminderWork.class)
